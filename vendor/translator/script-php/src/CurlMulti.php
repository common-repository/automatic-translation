...
class CurlMulti
{
    ...
    public function prepareRequest($instance) {
        if (isset($_GET['linguise_action']) && ($_GET['linguise_action'] == 'clear-cache')) {
            return false;
        }
        ...
        curl_setopt($ch, CURLOPT_URL, Request::getInstance()->getBaseUrl() . '/zz-zz/?translator_action=' . $instance->_action);
