...
class Updater
{
    ...
    public function update()
    {
        ...
        if (version_compare($result->version, TRANSLATOR_SCRIPT_TRANSLATION_VERSION, '<=')) {
        ...
        if (!rename($backup_folder . DIRECTORY_SEPARATOR . $data_folder_name . DIRECTORY_SEPARATOR . 'tmp' . DIRECTORY_SEPARATOR . 'update' . DIRECTORY_SEPARATOR . 'translator' , $base_folder)) {
        ...
        if (class_exists('Translator\Core\AfterUpdate') && method_exists('Translator\Core\AfterUpdate', 'afterUpdateRun')) {
